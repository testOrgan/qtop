...
@pytest.mark.parametrize(
    "fin, t",
    (
        (["  oar:\n", "    oarnodes_s_file: oarnodes_s_Y.txt\n"], [[1, "oar:"], [1, "oarnodes_s_file:", "oarnodes_s_Y.txt"]]),
        (["    oarstat_file: oarstat.txt\n", "  sge"], [[2, "oarstat_file:", "oarstat.txt"], [-1, "sge"]]),
        (
...
# @pytest.mark.current
@pytest.mark.parametrize(
    "line_in, fin, block_out, line_out",
    (
        (
            [0],
            """testkey1: testvalue1
...
""".split("\n"),
  ...
  - value14
""".split("\n"),
            {"testkey8": {"-": [{"testkey9": {"testkey10": "value10"}}, {"testkey11": {"testkey12": "value12"}}, {"testkey13": "value13"}, "value14"]}},
            [-1],
        ),
        (
            [0],
...
""".split("\n"),
 ...
 - testkey33:
    ...
    - testvalue35
""".split("\n"),
            {"testkey31": {"-": [{"testkey32": ["testvalue32", "testvalue32b"]}, {"testkey33": {"-": ["testvalue34", "testvalue35"]}}]}},
            [-2],
        ),
        (
            [0],
...
""".split("\n"),
            {
                "state_abbreviations": {
                    "pbs": {"Q": "queued_of_user", "E": "exiting_of_user", "W": "waiting_of_user"},
                    "oar": {"E": "Error", "F": "Finishing", "S": "cancelled_of_user"},
                    "sge": {"r": "running_of_user", "E": "exiting_of_user", "qw": "queued_of_user"},
                }
            },
            [-2],
        ),
